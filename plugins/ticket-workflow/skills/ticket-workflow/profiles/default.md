...
- Safety cap appended to every spawned sibling's briefing: "Implement and test, then stop at a
  ...
  comments too (a restack request among them). On cloud a restack request reaches you only
  through a one-shot Routine your epic coordinator schedules, or when the owner opens your
  session. Wait on CI in-turn after a push,
