...
- [ ] Final self-review ran on the final diff before hand-back (Step 8, always — not only when the diff grew), recorded in the same section: its `Final diff:` line no longer reads `pending`
