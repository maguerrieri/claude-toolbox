...
2. Take the player's intent. A turn that lays out several steps is a plan: play it forward and stop at its first real fork, not its end (gm-craft: stop at the first real fork).
