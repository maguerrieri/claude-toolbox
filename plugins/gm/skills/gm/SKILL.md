...
2. Take the player's intent. A turn that lays out several steps is a plan: work through it a step at a time, running steps 3–6 for each step that needs them, and stop at its first real fork, not its end (gm-craft: stop at the first real fork).
