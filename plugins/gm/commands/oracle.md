...
- For a **yes/no** question (pass it as $ARGUMENTS): `roll table <adapter>/oracles/yes-no.md`, then interpret the band into a one- or two-sentence answer in the fiction.
